...
export LDFLAGS="-L$SNAP/usr/lib/gcc/$SNAPCRAFT_ARCH_TRIPLET/8 -L$SNAP/usr/lib/$SNAPCRAFT_ARCH_TRIPLET -L$SNAP/lib/$SNAPCRAFT_ARCH_TRIPLET -lblkid -lgcrypt -llzma -llz4 -lgpg-error -luuid -lpthread -ldl -L$SNAP/usr/lib/ $LDFLAGS"
