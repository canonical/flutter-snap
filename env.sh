...
export LDFLAGS="-L$SNAP/usr/lib/gcc/$SNAPCRAFT_ARCH_TRIPLET/9 -L/lib/$SNAPCRAFT_ARCH_TRIPLET -L$SNAP/usr/lib/$SNAPCRAFT_ARCH_TRIPLET -L$SNAP/usr/lib/ -lblkid -lgcrypt -llzma -lpthread -lrt $LDFLAGS"
